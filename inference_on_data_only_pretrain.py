...
model_to_eval_path = '/cluster/work/igp_psr/dslab_FS25_data_and_weights/pretrained_models/model_2025-04-30-23-22-21/'
...
if model_config["model_type"] == "TwoStageModel":
    input_size += len(model_config['optional_features'])
