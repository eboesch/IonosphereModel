...
if __name__ == "__main__":
    ...
    dataset_train = dataset_class(datapaths_train, "train", logger, pytables=pytables, solar_indices_path=config['solar_indices_path'], optional_features=config['optional_features'])
    x, y = dataset_train[0]
    input_features = x.shape[0]
    dataset_val = dataset_class(datapaths_val, "val", logger, pytables=pytables, solar_indices_path=config['solar_indices_path'], optional_features=config['optional_features'])
    dataset_test = dataset_class(datapaths_test, "test", logger, pytables=pytables, solar_indices_path=config['solar_indices_path'], optional_features=config['optional_features'])
